function ActiveReactionFluxes = getActiveReactionsWithFluxesFromModelAndIrrevTROR_Adjustment(taskModel, solution,expValueMeanAdjustedTask,score , i, osenseStr , irrev,j, alpha, beta, epsilon)
...
newVector(round(abs(solution.cont(1:reactionLength)),6)>= (epsilon-(espilon/100))) = 1;
...
solutionName = string("lastValidSolutionMILP_OR_Adjust"+dispName+".mat");
newModelName = string("newModelMILP_OR_Adjust"+dispName+".mat");
fluxSolutionName = string("fluxTableMILP_OR_Adjust"+dispName+".mat");
