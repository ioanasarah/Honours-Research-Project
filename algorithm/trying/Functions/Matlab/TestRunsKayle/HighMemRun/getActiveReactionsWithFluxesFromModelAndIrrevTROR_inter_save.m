...
dispName =  sprintf("T%i_S%i_Scored%.3f_avg%.3f_alpha%.3f_beta%.3f_%s",i,j,score,averageScore,alpha,beta,currentDateTime);
...
writecell(ActiveReactionFluxes,string("ActiveRxnsTask"+dispName+".xlsx"),'Sheet','ActiveReactionsTask','Range','A1');
