function [ActiveReactionFluxes, reactionsToKeepLP,scoreLP] = runLPProblemOneOverGeneExpression(taskModel, expValueMeanAdjustedTask, i, orphanHandling,j,irrev,osenseStr)
...
reactionsToKeepLP = newVector == 1;
 ...
 [ActiveReactionFluxes,scoreLP] = getActiveReactionsWithFluxesFromModelAndSaveModelFunctionForLP(taskModel, solutionLP,expValueMeanAdjustedTask,score , i, osenseStr , irrev,j);
end