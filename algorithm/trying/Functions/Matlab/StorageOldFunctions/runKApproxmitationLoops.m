function [solution,score,reactionsToKeep] = runKApproxmitationLoops(taskModel, expValueMeanAdjustedTask, epsilon)
...
MILPproblem = createKMILPProblemAverageExpressionLoops(taskModel, expValueMeanAdjustedTask, epsilon, ktest);
