function ActiveReactionFluxes = getActiveReactionsWithFluxes_Final_solution_LP7(taskModel, solution,expValueMeanAdjustedTask,score , i, j, epsilon)
...
solutionName = string("lastValidSolution_Converged_Solution"+dispName+".mat");
newModelName = string("newModel_Converged_Solution"+dispName+".mat");
fluxSolutionName = string("fluxTable_Converged_Solution"+dispName+".mat");
...
writecell(ActiveReactionFluxes,string("ActiveReactionsTask_Converged_"+dispName+".xlsx"),'Sheet','ActiveReactionsTask','Range','A1');
