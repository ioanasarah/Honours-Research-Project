...
class CombinationFileCreation:
    ...
    def allocate_gene_values_to_reactions(
        ...
        genes_that_can_be_trimmed = CombinationFileCreation.assign_trimmable_gene_status(
            cobra_model,
            expression_data,
    ...
    def create_and_save_dataframes_from_matrices(
        ...
        for sample in range(reaction_expression_matrix.shape[1]):
            ...
            if gene_contribution_matrix is not None:
                gene_contribution_df_sample = pd.DataFrame(gene_contribution_matrix[:, sample], index=genes_ids,
    ...
    def transform_reversible_expression_to_irreversible(
        ...
        for idx, reaction in enumerate(rev_to_irrev_list):
            ...
            if len(rev_to_irrev_list[idx]) > 1:
                irreversible_expression_matrix[rev_to_irrev_list[idx][1] - 1, :] = reaction_expression_matrix[
...
if __name__ == "__main__":
    methods_dict_for_improved = {
        "__global_options": {
            # Preprocessing
            "model_type": "irr",
            "tasklist": "metabolic_tasks_2024_v1_01",
            "model_version": "other_model",
            "expression_dataset": "expression_datasets",
            "transformation": "NT",
            "thresholding": "NT",
            "GPR_method": "min1Sum",
            "should_filter_potential_trim_genes": True,
            ...
            "result_output_folder": r"C:\Ioana\_uni\honours\slp\algorithm\trying\Results",
    ...
    main_data_folder = r"C:\Ioana\_uni\honours\slp\algorithm\trying"
