...
if TYPE_CHECKING:
    ...
    from Functions.externals.MaCSBio_cobrapy import Model
...
class CobraYAML(YAML):
    ...
    def dump(
        ...
        ----------
        data : dict
            A dictionary representing the Functions.externals.MaCSBio_cobrapy model and its components.
...
def to_yaml(model: "Model", sort: bool = False, **kwargs: Any) -> str:
    ...
    **kwargs : Any
    ...
    -------
    str
        YAML string representation of the Functions.externals.MaCSBio_cobrapy model.
...
def from_yaml(document: str) -> "Model":
    """Load a Functions.externals.MaCSBio_cobrapy model from a YAML string.

    Parameters
    ----------
    document : str
        The YAML string representation of a Functions.externals.MaCSBio_cobrapy model.

    Returns
    -------
    Functions.externals.MaCSBio_cobrapy.Model
        The Functions.externals.MaCSBio_cobrapy model as interpreted from the YAML document.
...
def save_yaml_model(
    ...
    """Write the Functions.externals.MaCSBio_cobrapy model to a file in YAML format.
...
def load_yaml_model(filename: Union[str, Path]) -> "Model":
    """Load a Functions.externals.MaCSBio_cobrapy model from a file in YAML format.
    ...
    -------
    Functions.externals.MaCSBio_cobrapy.Model
        The Functions.externals.MaCSBio_cobrapy model as represented in the YAML document.
