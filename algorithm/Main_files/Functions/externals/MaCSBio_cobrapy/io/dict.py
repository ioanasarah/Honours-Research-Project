...
if TYPE_CHECKING:
    from Functions.externals.MaCSBio_cobrapy import Object
...
def _update_optional(
    ...
    Parameters
    ----------
    cobra_object : Functions.externals.MaCSBio_cobrapy.Object
        The Functions.externals.MaCSBio_cobrapy Object to update optional attributes from.
    new_dict : dict
...
def _metabolite_to_dict(metabolite: Metabolite) -> OrderedDict:
    """Convert a Functions.externals.MaCSBio_cobrapy Metabolite object to dictionary.

    Parameters
    ----------
    metabolite : Functions.externals.MaCSBio_cobrapy.Metabolite
        The Functions.externals.MaCSBio_cobrapy.Metabolite to convert to dictionary.
    ...
    See Also
    --------
    _metabolite_from_dict : Convert a dictionary to Functions.externals.MaCSBio_cobrapy Metabolite object.
...
def _metabolite_from_dict(metabolite: Dict) -> Metabolite:
    """Convert a dictionary to Functions.externals.MaCSBio_cobrapy Metabolite object.

    Parameters
    ----------
    metabolite : dict
        The dictionary to convert to Functions.externals.MaCSBio_cobrapy.Metabolite .

    Returns
    -------
    Functions.externals.MaCSBio_cobrapy.Metabolite

    See Also
    --------
    _metabolite_to_dict : Convert a Functions.externals.MaCSBio_cobrapy Metabolite object to dictionary.
...
def _gene_to_dict(gene: Gene) -> OrderedDict:
    """Convert a Functions.externals.MaCSBio_cobrapy Gene object to dictionary.

    Parameters
    ----------
    gene : Functions.externals.MaCSBio_cobrapy.Gene
        The Functions.externals.MaCSBio_cobrapy.Gene to convert to dictionary.
    ...
    See Also
    --------
    _gene_from_dict : Convert a dictionary to Functions.externals.MaCSBio_cobrapy Gene object.
...
def gene_from_dict(gene: Dict) -> Gene:
    """Convert a dictionary to Functions.externals.MaCSBio_cobrapy Gene object.

    Parameters
    ----------
    gene : dict
        The dictionary to convert to Functions.externals.MaCSBio_cobrapy.Gene .

    Returns
    -------
    Functions.externals.MaCSBio_cobrapy.Gene
        The converted Functions.externals.MaCSBio_cobrapy.Gene object.

    See Also
    --------
    _gene_to_dict : Convert a Functions.externals.MaCSBio_cobrapy Gene object to a dictionary.
...
def _reaction_from_dict(reaction: Dict, model: Model) -> Reaction:
    """Convert a dictionary to a Functions.externals.MaCSBio_cobrapy Reaction object.

    Parameters
    ----------
    reaction : dict
        The dictionary to convert to Functions.externals.MaCSBio_cobrapy.Reaction .
    ...
    Functions.externals.MaCSBio_cobrapy.Reaction
        The converted Functions.externals.MaCSBio_cobrapy.Reaction object.

    See Also
    --------
    _reaction_to_dict : Convert a Functions.externals.MaCSBio_cobrapy Reaction object to a dictionary.
