...
def to_json(model: "Model", sort: bool = False, **kwargs: Any) -> str:
    ...
    **kwargs : Any
    ...
    -------
    str
        JSON string representation of the Functions.externals.MaCSBio_cobrapy model.
...
def from_json(document: str) -> "Model":
    """Load a Functions.externals.MaCSBio_cobrapy model from a JSON string.

    Parameters
    ----------
    document : str
        The JSON string representation of a Functions.externals.MaCSBio_cobrapy model.

    Returns
    -------
    Functions.externals.MaCSBio_cobrapy.Model
        The Functions.externals.MaCSBio_cobrapy model as interpreted from the JSON string.
...
def load_json_model(filename: Union[str, Path, IO]) -> "Model":
    """Load a Functions.externals.MaCSBio_cobrapy model from a file in JSON format.
    ...
    -------
    Functions.externals.MaCSBio_cobrapy.Model
        The Functions.externals.MaCSBio_cobrapy model as represented in the JSON document.
