...
def save_matlab_model(
    ...
    """Save the Functions.externals.MaCSBio_cobrapy model as a .mat file.
...
def mat_parse_annotations(
    ...
    Parameters
    ----------
    target_list: list[Functions.externals.MaCSBio_cobrapy.Object]
        A list of Functions.externals.MaCSBio_cobrapy objects, including metabolites, reactions or genes. The
...
def annotations_to_mat(
    ...
    annotation_list: list[Dict]
        A list of Functions.externals.MaCSBio_cobrapy annotations, in the form of a dictionary.
    d_replace: str
        A string that points to the dictionary of converstions between MATLAB and
