...
def find_external_compartment(model: "Model") -> str:
    ...
    model : Functions.externals.MaCSBio_cobrapy.Model
        The Functions.externals.MaCSBio_cobrapy model whose external compartments are to be identified.
...
def find_boundary_types(
    ...
    ----------
    model : Functions.externals.MaCSBio_cobrapy.Model
        The Functions.externals.MaCSBio_cobrapy model whose boundary reactions are to be found.
    boundary_type : {"exchange", "demand", "sink"}
        Boundary type to check for.
    ...
    Returns
    -------
    list of Functions.externals.MaCSBio_cobrapy.Reaction or an empty list
