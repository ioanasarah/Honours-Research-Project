...
from Functions.externals.MaCSBio_cobrapy.exceptions import (
    OPTLANG_TO_EXCEPTIONS_DICT,
    OptimizationError,
    SolverNotFound,
)
from Functions.externals.MaCSBio_cobrapy.util.context import get_context
...
def linear_reaction_coefficients(
    ...
    model : Functions.externals.MaCSBio_cobrapy.Model
        The Functions.externals.MaCSBio_cobrapy model defining the linear objective.
    reactions : list of Functions.externals.MaCSBio_cobrapy.Reaction, optional
...
def interface_to_str(interface: Union[str, ModuleType]) -> str:
    ...
    interface : str, ModuleType
        Full name of the interface in optlang or Functions.externals.MaCSBio_cobrapy representation.
...
def add_lexicographic_constraints(
    ...
    objectives : list of Functions.externals.MaCSBio_cobrapy.Reaction
