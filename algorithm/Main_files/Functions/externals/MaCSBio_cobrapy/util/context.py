...
class HistoryManager:
    ...
    changes to a `Functions.externals.MaCSBio_cobrapy.core.Model`.
...
def get_context(obj: "Object") -> Optional[HistoryManager]:
    ...
    Parameters
    ----------
    obj: Functions.externals.MaCSBio_cobrapy.Object
        The Functions.externals.MaCSBio_cobrapy.Object for which to search context manager.
    ...
    """
    # works for Functions.externals.MaCSBio_cobrapy.core.Model objects
    try:
        return obj._contexts[-1]
    except (AttributeError, IndexError):
        pass
    # works for objects other than Functions.externals.MaCSBio_cobrapy.core.Model
    try:
...
def resettable(func: Callable[[Any], Any]) -> Callable[[Any], Any]:
    ...
    `Functions.externals.MaCSBio_cobrapy.util.HistoryManager`.
