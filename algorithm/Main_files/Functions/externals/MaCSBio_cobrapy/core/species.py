...
class Species(Object):
    ...
    def __init__(
        ...
        A species also contains a _model, reference to a Functions.externals.MaCSBio_cobrapy.model (initialized as
        None) and a self._reaction, a set of Functions.externals.MaCSBio_cobrapy.reactions (initialized as empty set).
        """
    ...
    def copy(self) -> "Species":
        ...
        Additionally, a copy of a reaction is no longer in a Functions.externals.MaCSBio_cobrapy.Model.
    ...
    def model(self) -> Optional["Model"]:
        ...
        -------
        model
            Returns the Functions.externals.MaCSBio_cobrapy model that the species is associated with. None if there
