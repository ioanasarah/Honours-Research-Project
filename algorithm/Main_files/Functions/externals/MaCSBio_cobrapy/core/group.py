...
class Group(Object):
    ...
    subsystems, or other custom groupings of objects within a Functions.externals.MaCSBio_cobrapy.Model
    object.
    ...
    members : iterable, optional
        A DictList containing references to Functions.externals.MaCSBio_cobrapy.Model-associated objects
    ...
    def remove_members(self, to_remove: list) -> None:
        ...
        ----------
        to_remove : list
            A list of Functions.externals.MaCSBio_cobrapy objects to remove from the group
        """
