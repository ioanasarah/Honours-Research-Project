...
class DictList(list):
    ...
    def index(self, id: Union[str, Object], *args) -> int:
        ...
        Parameters
        ----------
        id: A string or a :class:`~Functions.externals.MaCSBio_cobrapy.core.Object.Object`
    ...
    def __contains__(self, entity: Union[str, Object]) -> bool:
        ...
        Parameters
        ----------
        entity: str or :class:`~Functions.externals.MaCSBio_cobrapy.core.Object.Object`
