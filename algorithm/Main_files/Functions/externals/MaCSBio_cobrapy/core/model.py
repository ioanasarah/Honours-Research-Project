...
if TYPE_CHECKING:
    ...
    from Functions.externals.MaCSBio_cobrapy import Solution
    from Functions.externals.MaCSBio_cobrapy.summary import ModelSummary
    from Functions.externals.MaCSBio_cobrapy.util.solver import CONS_VARS
...
class Model(Object):
    """Class representation for a Functions.externals.MaCSBio_cobrapy model.
    ...
    def __init__(
        ...
        if isinstance(id_or_model, Model):
            ...
            self.genes = DictList()
            self.reactions = DictList()  # A list of Functions.externals.MaCSBio_cobrapy.Reactions
            self.metabolites = DictList()  # A list of Functions.externals.MaCSBio_cobrapy.Metabolites
            self.groups = DictList()  # A list of Functions.externals.MaCSBio_cobrapy.Groups
            ...
            lean_model_loading = False # TODO remove

            interface = check_solver(configuration.solver)
            if not lean_model_loading:
                try:
                    self._solver = interface.Model()
                except GurobiError as e:
                    print(e)
                    warn("Could not verify Gurobi license (most likely due to connection issues)."
                         "Will attempt to set solver to alternative solver (glpk)")
                    ...
                    try:
                        ...
                        self._solver = None
                        warn("Attempt to set solver to alternative default solver failed."
                             "Loaded the model without any solver active!!! Any solver-based"
                             "functions will fail (Model.Optimize), and functions that add "
                             "reactions or metabolites will not add necessary constraints")
    ...
    def __setstate__(self, state: Dict) -> None:
        """Make sure all Functions.externals.MaCSBio_cobrapy.Objects in the model point to the model.
    ...
    def solver(self) -> "optlang.interface.Model":
        ...
        Examples
        --------
        # >>> from Functions.externals.MaCSBio_cobrapy.io import load_model
    ...
    def copy(self) -> "Model":
        ...
        Returns
        -------
        Functions.externals.MaCSBio_cobrapy.Model: new model copy
        """
        new = self.__class__()
        do_not_copy_by_ref = {
            "metabolites",
    ...
    def add_metabolites(self, metabolite_list: Union[List, Metabolite]) -> None:
        ...
        metabolite_list : list or Metabolite.
            A list of `Functions.externals.MaCSBio_cobrapy.core.Metabolite` objects. If it isn't an iterable
    ...
    def add_boundary(
        ...
        Parameters
        ----------
        metabolite : Functions.externals.MaCSBio_cobrapy.Metabolite
        ...
        Returns
        -------
        Functions.externals.MaCSBio_cobrapy.Reaction
            The created boundary reaction.

        Examples
        --------
        >>> from Functions.externals.MaCSBio_cobrapy.io load_model
        >>> model = load_model("textbook")
    ...
    def add_reactions(self, reaction_list: Iterable[Reaction]) -> None:
        ...
        ----------
        reaction_list : list
            A list of `Functions.externals.MaCSBio_cobrapy.Reaction` objects
        """
        ...
        def existing_filter(rxn: Reaction) -> bool:
            ...
            Parameters
            ----------
            rxn: Functions.externals.MaCSBio_cobrapy.Reaction
    ...
    def remove_reactions(
        ...
        reactions : list or reaction or str
            A list with reactions (`Functions.externals.MaCSBio_cobrapy.Reaction`), or their id's, to remove.
    ...
    def add_groups(self, group_list: Union[str, Group, List[Group]]) -> None:
        ...
        group_list : list or str or Group
            A list of `Functions.externals.MaCSBio_cobrapy.Group` objects to add to the model. Can also be a single
        ...
        def existing_filter(new_group: Group) -> bool:
            ...
            Parameters
            ----------
            new_group: Functions.externals.MaCSBio_cobrapy.Group
                Group to check.
    ...
    def remove_groups(self, group_list: Union[str, Group, List[Group]]) -> None:
        ...
        ----------
        group_list : list or str or Group
            A list of `Functions.externals.MaCSBio_cobrapy.Group` objects to remove from the model. Can also be a
    ...
    def get_associated_groups(
        ...
        Parameters
        ----------
        element: `Functions.externals.MaCSBio_cobrapy.Reaction`, `Functions.externals.MaCSBio_cobrapy.Metabolite`, or `Functions.externals.MaCSBio_cobrapy.Gene`

        Returns
        -------
        list of `Functions.externals.MaCSBio_cobrapy.Group`
    ...
    def problem(self) -> "optlang.interface":
        ...
        Solutions to Functions.externals.MaCSBio_cobrapy models are obtained by formulating a mathematical
    ...
    def variables(self) -> "Container":
        """Get the mathematical variables in the Functions.externals.MaCSBio_cobrapy model.

        In a Functions.externals.MaCSBio_cobrapy model, most variables are reactions. However,
    ...
    def constraints(self) -> "Container":
        """Get the constraints in the Functions.externals.MaCSBio_cobrapy model.

        In a Functions.externals.MaCSBio_cobrapy model, most constraints are metabolites and their
    ...
    def exchanges(self) -> List[Reaction]:
        ...
        See Also
        --------
        Functions.externals.MaCSBio_cobrapy.medium.find_boundary_types
        """
    ...
    def _populate_solver(
        ...
        ----------
        reaction_list: list
            A list of Functions.externals.MaCSBio_cobrapy.Reaction to add to the solver. This list will be
            constrained.
        metabolite_list: list, optional
            A list of Functions.externals.MaCSBio_cobrapy.Metabolite  to add to the solver. This list will be
    ...
    def optimize(
        ...
        parameters for Functions.externals.MaCSBio_cobrapy.solvers may be available and specified with the
    ...
    def objective(self) -> Union[optlang.Objective]:
        ...
        Henceforth, use `Functions.externals.MaCSBio_cobrapy.util.solver.linear_reaction_coefficients` to
    ...
    def summary(
        ...
        Parameters
        ----------
        solution : Functions.externals.MaCSBio_cobrapy.Solution, optional
        ...
        Returns
        -------
        Functions.externals.MaCSBio_cobrapy.ModelSummary
    ...
    def merge(
        ...
        Parameters
        ----------
        right : Functions.externals.MaCSBio_cobrapy.Model
