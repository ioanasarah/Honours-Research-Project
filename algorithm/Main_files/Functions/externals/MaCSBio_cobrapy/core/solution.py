...
if TYPE_CHECKING:
    from Functions.externals.MaCSBio_cobrapy import Metabolite, Model, Reaction
...
class Solution:
    """
    A unified interface to a `Functions.externals.MaCSBio_cobrapy.Model` optimization solution.
...
def get_solution(
    ...
    reactions : list, optional
        An iterable of `Functions.externals.MaCSBio_cobrapy.Reaction` objects. Uses `model.reactions`
        if None (default None).
    metabolites : list, optional
        An iterable of `Functions.externals.MaCSBio_cobrapy.Metabolite` objects. Uses `model.metabolites`
        if None (default None).
    raise_error : bool
    ...
    Returns
    -------
    Functions.externals.MaCSBio_cobrapy.Solution
