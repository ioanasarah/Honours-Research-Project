...
if TYPE_CHECKING:
    ...
    from Functions.externals.MaCSBio_cobrapy.core import Solution
    from Functions.externals.MaCSBio_cobrapy.summary.metabolite_summary import MetaboliteSummary
...
class Metabolite(Species):
    """Class for information about metabolite in Functions.externals.MaCSBio_cobrapy.Reaction.

    Metabolite is a class for holding information regarding
    a metabolite in a Functions.externals.MaCSBio_cobrapy.Reaction object.
    ...
    def __init__(
        ...
        """Initialize Metaboblite Functions.externals.MaCSBio_cobrapy Species.
    ...
    def summary(
        ...
        Returns
        -------
        Functions.externals.MaCSBio_cobrapy.summary.MetaboliteSummary
        ...
        """
        from Functions.externals.MaCSBio_cobrapy.summary import MetaboliteSummary
