"""Define base Object class in Functions.externals.MaCSBio_cobrapy."""

from typing import Optional


class Object:
    """Defines common behavior of object in Functions.externals.MaCSBio_cobrapy.core."""
    ...
    def __getstate__(self) -> dict:
        ...
        if "_model" in state:
            state["_model"] = None
        # #### JELLE BONTHUS ADDED THE FOLLOWING TO HANDLE MEMORYVIEW errors (2025-02-07)
