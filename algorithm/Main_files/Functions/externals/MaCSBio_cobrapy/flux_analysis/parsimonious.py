...
if TYPE_CHECKING:
    ...
    from Functions.externals.MaCSBio_cobrapy import Model, Reaction, Solution
...
def pfba(
    ...
    reactions : list of Functions.externals.MaCSBio_cobrapy.Reaction, optional
        List of Functions.externals.MaCSBio_cobrapy.Reaction. Implies `return_frame` to be true. Only
