...
if TYPE_CHECKING:
    from Functions.externals.MaCSBio_cobrapy import Reaction
...
class GapFiller:
    ...
    universal : Functions.externals.MaCSBio_cobrapy.Model, optional
    ...
    def fill(self, iterations: int = 1) -> List[List["Reaction"]]:
        ...
        Returns
        -------
        list of list of Functions.externals.MaCSBio_cobrapy.Reaction
...
def gapfill(
    ...
    >>> from Functions.externals.MaCSBio_cobrapy.flux_analysis import gapfill
