...
def assess(
    ...
    .. deprecated:: 0.10.0a1
              ...
              Functions.externals.MaCSBio_cobrapy.Configuration .

    Parameters
    ----------
    model : Functions.externals.MaCSBio_cobrapy.Model
        The Functions.externals.MaCSBio_cobrapy model to assess production capacity for.
    reaction : str or Functions.externals.MaCSBio_cobrapy.Reaction
...
def _optimize_or_value(model: "Model", value: float = 0.0) -> float:
    ...
    .. deprecated:: 0.22.0
              ...
              `Functions.externals.MaCSBio_cobrapy.Model.slim_optimize`.
...
def assess_precursors(
    ...
    """
    warn("Use Functions.externals.MaCSBio_cobrapy.sampling.reaction.assess_component() instead.", DeprecationWarning)
