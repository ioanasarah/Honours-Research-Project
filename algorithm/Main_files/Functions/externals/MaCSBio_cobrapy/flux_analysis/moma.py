...
if TYPE_CHECKING:
    from Functions.externals.MaCSBio_cobrapy.core import Model, Solution
...
def add_moma(
    ...
    .. [2] Becker, Scott A, Adam M Feist, Monica L Mo, Gregory Hannum,
           ...
           The Functions.externals.MaCSBio_cobrapy Toolbox.” Nature Protocols 2 (March 29, 2007): 727.
    """
