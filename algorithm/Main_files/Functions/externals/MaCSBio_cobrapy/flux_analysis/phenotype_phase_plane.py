...
if TYPE_CHECKING:
    ...
    from Functions.externals.MaCSBio_cobrapy import Model, Reaction
...
def production_envelope(
    ...
    reactions : list of Functions.externals.MaCSBio_cobrapy.Reaction
        A list of reaction objects.
    objective : dict or Functions.externals.MaCSBio_cobrapy.Model.objective, optional
        The objective (reaction) to use for the production envelope. Use the
        model's current objective if left missing (default None).
    carbon_sources : list of Functions.externals.MaCSBio_cobrapy.Reaction, optional
    ...
    Examples
    --------
    >>> import Functions.externals.MaCSBio_cobrapy.io
    >>> from Functions.externals.MaCSBio_cobrapy.flux_analysis import production_envelope
    >>> model = Functions.externals.MaCSBio_cobrapy.io.load_model("textbook")
...
def _add_envelope(
    ...
    c_input : list of Functions.externals.MaCSBio_cobrapy.Reaction
        The list of reaction objects acting as carbon inputs.
    c_output : list of Functions.externals.MaCSBio_cobrapy.Reaction
