...
def _multi_deletion(
    ...
    **kwargs,
    ...
    element_lists : list of Functions.externals.MaCSBio_cobrapy.Gene or Functions.externals.MaCSBio_cobrapy.Reaction
        List of Functions.externals.MaCSBio_cobrapy.Gene or Functions.externals.MaCSBio_cobrapy.Reaction to be deleted.
...
def _entities_ids(entities: List[Union[str, Gene, Reaction]]) -> List[str]:
    ...
    Parameters
    ----------
    entities : list of str or Functions.externals.MaCSBio_cobrapy.Gene or Functions.externals.MaCSBio_cobrapy.Reaction
...
def single_reaction_deletion(
    ...
    **kwargs,
    ...
    model : Functions.externals.MaCSBio_cobrapy.Model
        The metabolic model to perform deletions in.
    reaction_list : list of Functions.externals.MaCSBio_cobrapy.Reaction or str, optional
...
def single_gene_deletion(
    ...
    **kwargs,
    ...
    model : Functions.externals.MaCSBio_cobrapy.Model
        The metabolic model to perform deletions in.
    gene_list : list of Functions.externals.MaCSBio_cobrapy.Gene or str, optional
...
def double_reaction_deletion(
    ...
    **kwargs,
    ...
    model : Functions.externals.MaCSBio_cobrapy.Model
        The metabolic model to perform deletions in.
    reaction_list1 : list of Functions.externals.MaCSBio_cobrapy.Reaction or str, optional
        The first reaction list to be deleted. If not passed,
        all the reactions from the model are used (default None).
    reaction_list2 : list of Functions.externals.MaCSBio_cobrapy.Reaction or str, optional
...
def double_gene_deletion(
    ...
    **kwargs,
    ...
    model : Functions.externals.MaCSBio_cobrapy.Model
        The metabolic model to perform deletions in.
    gene_list1 : list of Functions.externals.MaCSBio_cobrapy.Gene or str, optional
        The first gene list to be deleted. If not passed,
        all the genes from the model are used (default None).
    gene_list2 : list of Functions.externals.MaCSBio_cobrapy.Gene or str, optional
...
class KnockoutAccessor:
    ...
    def __getitem__(
        ...
        Parameters
        ----------
        args : Functions.externals.MaCSBio_cobrapy.Reaction, Functions.externals.MaCSBio_cobrapy.Gene, str, set, or list
        ...
        if any(isinstance(args[0], t) for t in [Reaction, Gene, str]):
            ...
            raise ValueError(
                "Allowed indices are single Functions.externals.MaCSBio_cobrapy.Reaction or Functions.externals.MaCSBio_cobrapy.Gene, "
                "lists of Functions.externals.MaCSBio_cobrapy.Reaction of Functions.externals.MaCSBio_cobrapy.Gene, or lists of sets "
                "of Functions.externals.MaCSBio_cobrapy.Reaction or Functions.externals.MaCSBio_cobrapy.Gene."
            )
