...
if TYPE_CHECKING:
    from Functions.externals.MaCSBio_cobrapy import Gene, Model, Reaction
...
def find_blocked_reactions(
    ...
    on the current exchange reaction settings for a Functions.externals.MaCSBio_cobrapy model. Hence an
...
def find_essential_genes(
    ...
    Returns
    -------
    set of Functions.externals.MaCSBio_cobrapy.Gene
...
def find_essential_reactions(
    ...
    Returns
    -------
    set of Functions.externals.MaCSBio_cobrapy.Reaction
