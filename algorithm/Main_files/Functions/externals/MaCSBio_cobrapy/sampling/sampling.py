"""Provide a wrapper function for performing flux sampling of Functions.externals.MaCSBio_cobrapy models."""
...
def sample(
    ...
    """Sample valid flux distributions from a Functions.externals.MaCSBio_cobrapy model.
