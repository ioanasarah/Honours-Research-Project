...
from Functions.externals.MaCSBio_cobrapy.util import constraint_matrices, create_stoichiometric_matrix, nullspace
...
class HRSampler(ABC):
    ...
    model : Functions.externals.MaCSBio_cobrapy.Model
        The Functions.externals.MaCSBio_cobrapy model from which to generate samples.
    thinning : int
