# -*- coding: utf-8 -*-
'''
This is taken from the dash_bio package, as it requires a dependency
that itself requires C++ 14 which not everyone will have. The specific
code for the clustergram function does not utilize this, so I took it and put
it here directly. Small tweaks were made (specifically to the default color):
It now is PuOr.
