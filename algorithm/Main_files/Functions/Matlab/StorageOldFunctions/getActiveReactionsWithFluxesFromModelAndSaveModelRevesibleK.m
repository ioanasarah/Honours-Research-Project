function ActiveReactionFluxes = getActiveReactionsWithFluxesFromModelAndSaveModelRevesibleK(taskModel, solution,expValueMeanAdjustedTask,score , i, osenseStr , irrev,j)
...
solutionName = string("lastValidSolutionMILPReversibleK"+dispName+".mat");
newModelName = string("newModelMILPReversibleK"+dispName+".mat");
fluxSolutionName = string("fluxTableMILPReversibleK"+dispName+".mat");
