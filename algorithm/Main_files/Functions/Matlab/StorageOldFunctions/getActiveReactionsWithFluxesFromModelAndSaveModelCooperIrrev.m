function ActiveReactionFluxes = getActiveReactionsWithFluxesFromModelAndSaveModelCooperIrrev(taskModelCooperIrrev, solutionFractionalIrrev,expValueMeanAdjustedTaskCharnesCooperIrrev,score , i, osenseStr , irrev,j)
...
solutionName = string("lastValidSolutionCooperIrrev"+dispName+".mat");
newModelName = string("newModelCooperIrrev"+dispName+".mat");
fluxSolutionName = string("fluxTableCooperIrrev"+dispName+".mat");
