function MILPproblem = FractionalProgramming_ConstructMILP(model,expressionRxns, epsilon = 0.0001)
...
expressionRxns = 1*abs(randn(length(model.rxns),1));
...
% expressionRxns(testRxnHighIds) = 10000000;
