function MILPproblem = createKMILPProblemAverageExpressionLoops(model, expressionRxns, epsilon,k )
%tic
...
% Column length equals S matrix + 2Y*rxn + 2z*rxn + 1*t )
c_v = zeros(reactionLength,1); % no maximiization, just getting a feasible model
...
%b_t_M_LB = 0;
%b_t_M_UB = M;
b = [b_s;lb_indices;ub_indices;b_Yprime;b_yprime_LB;b_yprime_UB;b_AverageExpressRow;];
%
...
%csense15(1) = 'G'; % t >= 0
%csense16(1) = 'L'; % t <= M
csense = [csense1 csense2 csense3  csense5 csense10 csense11 csense14];
