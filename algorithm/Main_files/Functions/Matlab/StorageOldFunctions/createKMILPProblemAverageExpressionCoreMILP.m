function MILPproblem = createKMILPProblemAverageExpressionCoreMILP(model )
tic


epsilon = 1;
k = 0;
expressionRxns = -1*ones(size(model.rxns,1),1);
...
c_y = zeros(reactionLength*2,1); % don't maximize y
