...
reactionsToKeepLP = newVector == 1;
 ...
 [ActiveReactionFluxes,scoreLP] = getActiveReactionsWithFluxesFromModelAndSaveModelMinimumReactions(taskModel, solutionLP,expValueMeanAdjustedTask,score , i, osenseStr , irrev,j);
end