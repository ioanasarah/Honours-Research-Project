function ActiveReactionFluxes = getActiveReactionsWithFluxesFromModelAndSaveModelUsedRxns(taskModel, solution,expValueMeanAdjustedTask,score , i, osenseStr , irrev,j)
...
solutionName = string("lastValidSolutionUsedRxnsKapprox"+dispName+".mat");
newModelName = string("newModelUsedRxnsKapprox"+dispName+".mat");
fluxSolutionName = string("fluxTableUsedRxnsKapprox"+dispName+".mat");
