function MILPproblem = createKMILPProblemAverageExpressionNoYiMinusLoopLaw(model, expressionRxns, epsilon, rev2irrev,k )
tic
...
% Column length equals S matrix + 2Y*rxn + 2z*rxn + 1*t )
c_v = ones(reactionLength,1); % we minimize v
