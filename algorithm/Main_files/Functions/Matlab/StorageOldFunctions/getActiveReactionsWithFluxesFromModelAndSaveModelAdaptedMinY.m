function ActiveReactionFluxes = getActiveReactionsWithFluxesFromModelAndSaveModelAdaptedMinY(taskModel, solution,expValueMeanAdjustedTask,score , i, osenseStr , irrev,j)
...
newVector = zeros(size(solution.cont)); 
newVector(abs(solution.cont) > 0.99 | yiFlagsPlus ~= 0) = 1;
...
solutionName = string("lastValidSolutionMILPAdaptedMinY"+dispName+".mat");
newModelName = string("newModelMILPAdaptedMinY"+dispName+".mat");
fluxSolutionName = string("fluxTableMILPAdaptedMinY"+dispName+".mat");
