function [solution,score,reactionsToKeep] = runKApproxmitationAdaptedNoYMinus (taskModel, expValueMeanAdjustedTask, epsilon, rev2irrev)
...
MILPproblem = createKMILPProblemAverageExpressionAdaptedNoYiMinus(taskModel, expValueMeanAdjustedTask, epsilon, rev2irrev, ktest);
