...
for i=1:1%size(taskStructure,1)%, 1)%param.doParallel)
    ...
    for j=1:1%SampleNumber % For testing, adjust to 1 or whatever sample number you want
        ...
        if PassTask
            ...
            [solutionIrrevFilterLoopLawKapproxTROR_Adjustment,scoreIrrevFilterLoopLawKapproxTROR_Adjustment,reactionsToKeepIrrevFilterLoopLawKapproxTROR_Adjustment] = runKApproxmitationIrrevTROR_AdjustmentV4 (newIrrevModelKapprox, expValueMeanAdjustedTaskIrrevKapprox, epsilon, rev2irrevIrrevKapprox, alpha, beta,i,j,osenseStr,irrev,orphanHandling);
            ...
            [newSolution, prunedModel, originalModel, adjustedExpressionData] = runRxnsMinimalizationUsingIMAT(newIrrevModelKapprox, solutionIrrevFilterLoopLawKapproxTROR_Adjustment, expValueMeanAdjustedTaskIrrevKapprox,length(newIrrevModelKapprox.rxns), epsilon,TurnOnLoopConstraints);
