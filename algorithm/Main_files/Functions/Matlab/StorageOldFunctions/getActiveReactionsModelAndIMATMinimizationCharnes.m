function ActiveReactionFluxes = getActiveReactionsModelAndIMATMinimizationCharnes(taskModel, solution,expValueMeanAdjustedTask,score , i, osenseStr , irrev,j, alpha, beta, epsilon)
